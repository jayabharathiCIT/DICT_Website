...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-container">
        ...
        <div class="row">
            ...
            <div class="col-9">
                <asp:TextBox CssClass="form-control" ID="txtSource" runat="server" placeholder="Location(required)"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Location is required" ControlToValidate="txtSource"></asp:RequiredFieldValidator>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-2">
                <asp:TextBox CssClass="form-control" TextMode="time" ID="TextBox2" runat="server"></asp:TextBox>
