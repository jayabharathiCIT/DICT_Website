           ...
           <%-- <asp:TableRow Width="250" >
            ...
            <asp:TableRow Width="250" >
                ...
                <asp:TableCell>
                    ...
                    <asp:Label ID="lblError" runat="server" Text="" CssClass="textLablesSmall"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
            ...
            <asp:TableRow Width="250" >
                ...
                <asp:TableCell>
                     <asp:TextBox ID="tbDate" runat="server" placeholder="Select a Date" CssClass="txtControlRegister"></asp:TextBox>
