...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
 ...
 <%-------------------------------------------------- Title --%>
            <div class="row">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Title is required" ControlToValidate="txtTitle"></asp:RequiredFieldValidator>   </div>
   </div>
             <%-------------------------------------------------- Date --%>
            <div class="row">
                <div class="col-3">
            ...
            <div class="row">
                ...
                <div class="col-9">
                    <asp:DropDownList ID="ddlCategory" runat="server" placeholder="You must select a acategory" AppendDataBoundItems="false"></asp:DropDownList>
            ...
            <div class="row">
             ...
             <%-------------------------------------------------- Submit --%>
            <div class="row">
                <asp:Button CssClass="btn btn-default btn-lg" ID="btnSubmit" runat="server" Text="Submit" OnClick="btnSubmit_Click" />
            </div>
        </div>
    </div>
</asp:Content>
